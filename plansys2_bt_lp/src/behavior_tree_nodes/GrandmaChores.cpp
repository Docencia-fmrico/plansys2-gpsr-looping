...
#include "plansys2_bt_lp/behavior_tree_nodes/GrandmaChores.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<plansys2_bt_lp::GrandmaChores>(
        name, "navigate_to_pose", config);
    };

  factory.registerBuilder<plansys2_bt_lp::GrandmaChores>(
    "GrandmaChores", builder);
}
