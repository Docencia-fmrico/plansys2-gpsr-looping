...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<plansys2_bt_lp::ItemForGrandma>(
        name, "navigate_to_pose", config);
    };

  factory.registerBuilder<plansys2_bt_lp::ItemForGrandma>(
    "ItemForGrandma", builder);
}
